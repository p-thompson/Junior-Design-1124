...
function UpdateAccount() {
    ...
    const [user2Info, setUser2Info] = useState(new Map([["user", ""], ["connections", history.location.state.get("connections")], ["requests", history.location.state.get("requests")], ["task", history.location.state.get("task")], ['search', history.location.state.get('search')], ["selectedUser", history.location.state.get("selectedUser")]]));
